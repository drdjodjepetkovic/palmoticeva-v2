...
import { Award, CalendarCheck, Clock, HeartPulse, Share2, Star, Lightbulb, ClipboardCheck, Bell, Newspaper, ArrowRight, Home, BookOpen, CalendarPlus, Phone, Tag, HelpCircle, Info, Download } from 'lucide-react';
                ...
                <Link href={`/${language}/menstrual-calendar`} className="h-full block">
                    <Card className="flex flex-col h-full hover:shadow-xl transition-all duration-300 bg-card text-card-foreground">
                        <CardContent className="flex-grow flex items-center p-4 gap-4">
                           <LucideIcons.CalendarHeart className="h-10 w-10 text-primary flex-shrink-0"/>
                           <div>
