...
export const defaultAboutPageContent: AboutPageContent = {
    ...
    story: {
        ...
        // 2026-04-18 — hero slika za /about: ordinacija/klinika unutrašnjost (iz PalmLondon reference repo).
        // Default/fallback; Firestore page_content/about override može da postavi drugu sliku preko admin panela.
        imageUrl: "/images/clinic-room.webp"
    },
    contact: {
