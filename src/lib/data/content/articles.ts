        ...
        content: {
            ...
            ru: `
                ...
                <ul>
                    ...
                    <li><strong>Активность:</strong> Возвращение к работе и легким видам деятельности возможно через несколько дней. Тяжелых физических нагрузок и половых контактов следует избегать в течение <strong>4-6 недель</strong>.</li>
                </ul>
                <p>Бесплатные контрольные осмотры после вмешательства включены в стоимость и проводятся по согласованию с врачом.</p>
                
                <h3>Каковы преимущества лабиопластики?</h3>
                <p>Помимо эстетического улучшения, лабиопластика приносит значительное улучшение качества жизни. Пациентки сообщают о повышении уверенности в себе, отсутствии боли и дискомфорта, а также об улучшении сексуальной функции. Удовлетворенность пациенток после этой процедуры чрезвычайно высока.</p>
                
                <p>Стоимость процедуры составляет 69 000 динаров и включает бесплатную предоперационную консультацию, само вмешательство и все необходимые контрольные осмотры. Запишитесь на консультацию и узнайте, является ли лабиопластика правильным решением для вас.</p>
            `
        },
        image: "https://firebasestorage.googleapis.com/v0/b/palmoticeva-portal.firebasestorage.app/o/images%2Flabioplastika-usluga.png?alt=media&token=c191a620-618d-4a1d-847e-8c3e80e90956",
        author: {
            "se-lat": "Dr Đorđe Petković",
            en: "Dr. Đorđe Petković",
            se: "Др Ђорђе Петковић",
