...
export const homepageContent: { [key: string]: ContentItem & { version: number } } = {
  hero_main_text: { en: "27 years of trust.", "se-lat": "27 godina poverenja.", se: "27 година поверења.", ru: "27 лет доверия.", version: CURRENT_CONTENT_VERSION },
  hero_button_text: { en: "All about us", "se-lat": "Sve o nama", se: "Све о нама", ru: "Все о нас", version: CURRENT_CONTENT_VERSION },
  homepage_notifications_title: { en: "My Notifications", "se-lat": "Moja Obaveštenja", se: "Моја Обавештења", ru: "Мои уведомления", version: CURRENT_CONTENT_VERSION },
  ...
  badge_explorer_desc: { en: "You have successfully logged your first cycle!", "se-lat": "Uspešno ste uneli svoj prvi ciklus!", se: "Успешно сте унели свој први циклус!", ru: "Вы успешно записали свой первый цикл!", version: CURRENT_CONTENT_VERSION },
  badge_routine_queen_title: { en: "Routine Queen", "se-lat": "Kraljica Rutine", se: "Краљица Рутине", ru: "Королева рутины", version: CURRENT_CONTENT_VERSION },
  badge_routine_queen_desc: { en: "You have logged 3 or more cycles. Consistency is key!", "se-lat": "Uneli ste 3 ili više ciklusa. Redovnost je ključ!", se: "Унели сте 3 или више циклуса. Редовност је кључ!", ru: "Вы записали 3 или более циклов. Постоянство - залог успеха!", version: CURRENT_CONTENT_VERSION },
  badge_punctual_title: { en: "Punctual as a clock", "se-lat": "Tačna kao sat", se: "Тачна као сат", ru: "Точна как часы", version: CURRENT_CONTENT_VERSION },
  badge_punctual_desc: { en: "You have successfully scheduled your first appointment.", "se-lat": "Uspešno ste poslali upit za svoj prvi termin.", se: "Успешно сте послали упит за свој први термин.", ru: "Вы успешно отправили запрос на свой первый прием.", version: CURRENT_CONTENT_VERSION },
  badge_ambassador_title: { en: "Ambassador", "se-lat": "Ambasador", se: "Амбасадор", ru: "Амбассадор", version: CURRENT_CONTENT_VERSION },
  badge_ambassador_desc: { en: "You have shared our app with friends. Thank you!", "se-lat": "Podelili ste našu aplikaciju sa prijateljima. Hvala!", se: "Поделили сте нашу апликацију са пријатељима. Хвала!", ru: "Вы поделились нашим приложением с друзьями. Спасибо!", version: CURRENT_CONTENT_VERSION },
  badge_golden_recommendation_title: { en: "Golden Recommendation", "se-lat": "Zlatna Preporuka", se: "Златна Препорука", ru: "Золотая рекомендация", version: CURRENT_CONTENT_VERSION },
  ...
  faq_card_desc: { en: 'Find answers to the most common questions.', 'se-lat': 'Pronađite odgovore na najčešća pitanja.', se: 'Пронађите одговоре на најчешћа питања.', ru: 'Найдите ответы на самые распространенные вопросы.', version: CURRENT_CONTENT_VERSION },
  rate_us_card_title: { en: 'Rate Us', 'se-lat': 'Ocenite nas', se: 'Оцените нас', ru: 'Оцените нас', version: CURRENT_CONTENT_VERSION },
  rate_us_card_desc: { en: 'Your feedback is important to us.', 'se-lat': 'Vaše mišljenje nam je važno.', se: 'Ваше мишљење нам је важно.', ru: 'Ваше мнение важно для нас.', version: CURRENT_CONTENT_VERSION },
  share_app_card_title: { en: 'Share the App', 'se-lat': 'Podelite aplikaciju', se: 'Поделите апликацију', ru: 'Поделиться приложением', version: CURRENT_CONTENT_VERSION },
  share_app_card_desc: { en: 'Share our app with your friends.', 'se-lat': 'Podelite našu aplikaciju sa prijateljima.', se: 'Поделите нашу апликацију са пријатељима.', ru: 'Поделитесь нашим приложением с друзьями.', version: CURRENT_CONTENT_VERSION },
  share_link_copied_toast: { en: 'Link copied to clipboard!', 'se-lat': 'Link kopiran!', se: 'Линк копиран!', ru: 'Ссылка скопирована!', version: CURRENT_CONTENT_VERSION },

  gamification_title: { en: "Your Badges", "se-lat": "Vaši Bedževi", se: "Ваши Беџеви", ru: "Ваши значки", version: CURRENT_CONTENT_VERSION },
  gamification_details_button: { en: "Details", "se-lat": "Detalji", se: "Детаљи", ru: "Подробности", version: CURRENT_CONTENT_VERSION },
  gamification_dialog_title: { en: "Collect all the badges!", "se-lat": "Sakupite sve bedževe!", se: "Сакупите све беџеве!", ru: "Соберите все значки!", version: CURRENT_CONTENT_VERSION },
  gamification_dialog_desc: { en: "The Palmotićeva Clinic has prepared a surprise gift for the most loyal users who collect all the badges. Good luck!", "se-lat": "Ordinacija Palmotićeva je za najvernije korisnice koje sakupe sve bedževe spremila poklon iznenađenja. Srećno!", se: "Ординација Палмотићева је за најверније кориснице које сакупе све беџеве спремила поклон изненађења. Срећно!", ru: "Клиника «Палмотичева» приготовила подарок-сюрприз для самых преданных пользователей, которые соберут все значки. Удачи!", version: CURRENT_CONTENT_VERSION },
  gamification_dialog_button: { en: "Okay", "se-lat": "U redu", se: "У реду", ru: "Хорошо", version: CURRENT_CONTENT_VERSION },
