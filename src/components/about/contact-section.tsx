            ...
            <Card className="shadow-lg flex flex-col">
                ...
                <div className="p-6 pt-0">
                    <Button asChild variant="outline" className="w-full">
                        ...
                        >
                            {t.about?.directions_button || "Directions"} <ArrowRight className="h-4 w-4 ml-2" />
                        </a>
                    </Button>
                </div>
            </Card>
            ...
            <Card className="shadow-lg flex flex-col">
                ...
                <div className="p-6 pt-0">
                    <Button asChild className="w-full" size="lg">
                        <Link href={`/${language}/appointments`}>{t.about?.booking_button || "Book Appointment"} <ArrowRight className="h-4 w-4 ml-2" /></Link>
                    </Button>
                </div>
            </Card>
        </section>
