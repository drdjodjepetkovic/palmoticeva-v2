...
import { conversationalAgent, type ConversationalAgentInput, type ConversationalAgentOutput, type HistoryItem } from '@/ai/flows/conversational-agent';
...
export default function AiAssistant() {
  ...
  const handleSend = useCallback(async (prompt: string) => {
    ...
    try {
      ...
      const response: ConversationalAgentOutput = await conversationalAgent({
          question: prompt,
          history: history,
          userId: user?.uid,
